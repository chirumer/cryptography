...
\href{https://www.usenix.org/system/files/sec21fall-cao.pdf}{USENIX PDF} &
Cao2020 \\
\midrule

Locally Differentially Private Protocols for Frequency Estimation &
\href{https://www.usenix.org/system/files/conference/usenixsecurity17/sec17-wang-tianhao.pdf}{USENIX PDF} &
Wang2017 \\
...
\href{https://dl.acm.org/doi/10.1145/3719027.3744839}{ACM DL} &
Li2025Mitig \\
...
\textbf{Paper Title} & \textbf{Link} & \textbf{Shortform} \\
\midrule
RAPPOR: Randomized Aggregatable Privacy‑Preserving Ordinal Response & \href{https://www.scopus.com/record/display.url?eid=2-s2.0-84910685712&origin=resultslist}{Scopus} & RAPPOR2014 \\
\midrule
Locally Differentially Private Frequency Estimation with Consistency & \href{https://www.ndss-symposium.org/wp-content/uploads/2020/02/24157-paper.pdf}{NDSS 2020 PDF} & Wang2020 \\
\end{longtable}

\subsection{Publication Details}

\begin{longtable}{p{0.15\textwidth}p{0.08\textwidth}p{0.22\textwidth}p{0.08\textwidth}p{0.35\textwidth}}
\toprule
\textbf{Shortform} & \textbf{Year} & \textbf{Venue} & \textbf{Rank} & \textbf{Google Scholar Category} \\
\midrule
RAPPOR2014 & 2014 & ACM CCS & \#5 & \href{https://scholar.google.es/citations?view_op=top_venues&hl=en&vq=eng_computersecuritycryptography}{Computer Security \& Cryptography} \\
\midrule
Wang2020 & 2020 & NDSS & \#7 & \href{https://scholar.google.es/citations?view_op=top_venues&hl=en&vq=eng_computersecuritycryptography}{Computer Security \& Cryptography} \\
\end{longtable}
...
\subsubsection{Relevance to Cao2020}
...
\subsubsection{Relevance to Wang2017}

Shows that OUE and OLH are not optimally parameterized, introducing improvements with RUE and RLH. The paper discusses OUE and OLH in the following sections:
...
\subsection{Li2025Mitig}

\subsubsection{Usefulness}

\begin{itemize}
\item This paper directly references Cao2020 
\item To be filled
\item To be filled
\end{itemize}
...
Builds on top of MGA (the strongest attack) introduced in Cao2020. Li2025Mitig discusses MGA and proposes defenses in the following sections:

\begin{longtable}{p{0.20\textwidth}p{0.70\textwidth}}
\toprule
\textbf{Li2025Mitig Section} & \textbf{Discussion} \\
\midrule
\endfirsthead
...
Section 3.2 &
Main formal description of MGA extended to different LDP protocols (OUE, OLH-User/Server, HST-User/Server, GRR) \\
\midrule

Section 4.1 &
Theoretical analysis of fake user detection including expected squared error under MGA and chi-square error statistics \\
\midrule

Section 5 &
Detection evaluation comparing methods such as Diffstats and FIAD against MGA attacks \\
\midrule

Figures 6 \& 8 &
Experimental results showing utility recovery and detection performance under MGA and MGA-A for various protocols \\
